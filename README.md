...
El objetivo de este proyecto es poder adquirir y consultar información de peliculas a traves de una API. Esta misma fue desarrollada gracias al framework de **FastAPI** y desplegada posteriormente en la plataforma de **Render**. Ademas, el proyecto cuenta con un sistema de recomendación de películas, gracias a un modelo de machine learning que utiliza la puntuacion del coseno de similitud entre los titulos y géneros de las peliculas para recomendar titulos similares al requerido.
...
URL base: `https://api-recommendation-movies.onrender.com/`

<br>

- Ruta: ***`/`***
- Descripción: Devuelve un mensaje de bienvenida para la API de Recomendación de Películas.
- Ejemplo de solicitud: https://api-recommendation-movies.onrender.com
...
- Ejemplo de solicitud: https://api-recommendation-movies.onrender.com/cantidad_filmaciones_mes/enero
...
- Ejemplo de solicitud: https://api-recommendation-movies.onrender.com/cantidad_filmaciones_dia/lunes
...
- Ejemplo de solicitud: https://api-recommendation-movies.onrender.com/score_titulo/Cars
...
- Descripción: Devuelve el título de una película, la cantidad de votos y la valoración promedio. Se requiere que la película tenga al menos 2000 valoraciones.
- Parámetros de entrada: *titulo* (str) - El título de la película.
- Ejemplo de solicitud: https://api-recommendation-movies.onrender.com/votos_titulo/Minions
...
- Ejemplo de solicitud: https://api-recommendation-movies.onrender.com/get_actor/Jim%20Carrey
...
- Ejemplo de solicitud: https://api-recommendation-movies.onrender.com/get_director/James%20Cameron
...
- Ejemplo de solicitud: https://api-recommendation-movies.onrender.com/recomendacion/Titanic
...
Puedes instalar los paquetes utilizando el gestor de paquetes pip de la siguiente manera:
...
Si te interesa agregar valor al proyecto, tu contribución será bienvenida. Te sugiero que clones este repositorio en tu computadora para que puedas trabajar con el libremente de manera local.
